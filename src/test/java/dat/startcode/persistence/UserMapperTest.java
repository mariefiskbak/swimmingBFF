...
class UserMapperTest
{
    ...
    {
        User newUser = UserFacade.createUser("jill@j.dk", "1234", "user", connectionPool);
        User logInUser = UserFacade.login("jill@j.dk","1234", connectionPool);
        User expectedUser = new User("jill@j.dk", "1234", "user");
